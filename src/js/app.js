/* build : 564493634@qq.com 2015-04-14 09:10:57 */
...
require.config({
  ...
  urlArgs : 'yaozhVersion=1.1.1'+'&d='+new Date().getTime(),
  waitSeconds : 5,
  map : {
    '*' : {
      'css' : 'require.css'
