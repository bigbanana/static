...
(function($) {
  $.fn.highchartTable = function() {
    ...
    this.each(function() {
      ...
      // 
      // 坑爹的caption标题，删掉没意见吧。——564493634@qq.com
      // var captions   = $('caption', table);
      var graphTitle = $table.data('graph-title-text') || '';
      ...
      var defaultColors = [
        ...
        /*'#7cb5ec','#f7a35c','#71d6c8','#89a54e','#434348','#8085e9','#f7605c','#90ed7d','#B5D6F6','#FFF57C'*/
        '#4298cc', '#97daea', '#6cc5e9', '#dad2c7', '#c6b9ad', '#cce981', '#6bc04b', '#6cc5e9'
      ];
      var colors = [];
